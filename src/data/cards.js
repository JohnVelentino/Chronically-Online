...
export const HEROES = [
  ...
  },
  {
    ...
    deckIds: [
      "cia_blacksite","cia_blacksite","uav_recon","uav_recon",
      "cia_wiretap","cia_wiretap","cia_asset_recruitment","cia_asset_recruitment",
      "cia_double_agent","cia_double_agent","cia_black_budget_analyst","cia_black_budget_analyst",
      "cia_drone_strike","skibidi_bomb","area_51_whistleblower","seal_team_six",
      "mk_ultra_intern","mk_ultra_intern","cia_psyop","cia_extraordinary_rendition",
    ],
  },
  {
    id: "elon",
...
export const CLASS_CARDS = [
  ...
  // ── CIA / USA! class ────────────────────────────────────────────────────────
  { id:"cia_blacksite",            name:"Blacksite",                 cost:4,              type:"spell",  desc:"Discover 3 cards from enemy hand. Destroy 1.",                              emoji:"🏚️", rarity:"epic",      effect:"cia_blacksite",              targetType:"none",   flavor:"the building doesn't exist bestie. neither will that card.",             class:"USA!" },
  { id:"cia_extraordinary_rendition", name:"Extraordinary Rendition", cost:3,              type:"spell",  desc:"Steal a random card from enemy hand. Refused if your hand is full.",        emoji:"✈️", rarity:"rare",      effect:"cia_extraordinary_rendition", targetType:"none",  flavor:"jet fueled. questions later.",                                           class:"USA!" },
  { id:"cia_wiretap",              name:"Wiretap",                    cost:2,              type:"spell",  desc:"Reveal enemy hand for 3 turns. Draw a card.",                               emoji:"🎧", rarity:"common",    effect:"cia_wiretap",                targetType:"none",   flavor:"patriot act vibes. we heard that.",                                      class:"USA!" },
  { id:"cia_asset_recruitment",    name:"Asset Recruitment",          cost:5,              type:"spell",  desc:"Discover 3 cards from top of enemy deck. Add a copy to your hand.",         emoji:"🤝", rarity:"epic",      effect:"cia_asset_recruitment",      targetType:"none",   flavor:"welcome to the agency. here's your briefcase.",                          class:"USA!" },
  { id:"cia_double_agent",         name:"Double Agent",               cost:3, atk:3, hp:4, type:"minion", desc:"Battlecry: Discover top 3 of enemy deck. Steal 1 into your hand.",         emoji:"🕵️", rarity:"epic",      keywords:["battlecry","cia_double_agent_discover"],                                     flavor:"yes sir, they trust me. no sir, I don't.",                              class:"USA!" },
  { id:"cia_black_budget_analyst", name:"Black Budget Analyst",       cost:4, atk:3, hp:5, type:"minion", desc:"Battlecry: Steal the top card of enemy deck.",                              emoji:"💼", rarity:"rare",      keywords:["battlecry","cia_black_budget_steal_top"],                                    flavor:"line item redacted. line item cashed.",                                  class:"USA!" },
  { id:"cia_dead_drop",            name:"Dead Drop",                  cost:3, atk:3, hp:3, type:"minion", desc:"Deathrattle: Steal the top card of enemy deck.",                             emoji:"📦", rarity:"rare",      keywords:["deathrattle","cia_dead_drop_deathrattle"], effectConfig: { on_death: { type: "steal_top_enemy_deck_card" } },               flavor:"brick in the wall. message in the brick.",                               class:"USA!" },
  { id:"cia_drone_strike",         name:"Drone Strike",               cost:5,              type:"spell",  desc:"Deal 4 damage to all enemy minions.",                                         emoji:"🛸", rarity:"rare",      effect:"cia_drone_strike",           targetType:"none",   flavor:"we were never there. the drones were never there. you weren't either.", class:"USA!" },
  { id:"cia_psyop",                name:"Psyop",                      cost:2,              type:"spell",  desc:"Reveal enemy hand this turn. Enemy discards a random card.",                  emoji:"🧠", rarity:"rare",      effect:"cia_psyop",                  targetType:"none",   flavor:"gaslight, gatekeep, greenlight bestie.",                                class:"USA!" },
  { id:"cia_classified_memo",      name:"Classified Memo",            cost:2,              type:"spell",  desc:"Peek top 3 of enemy deck. Draw a card.",                                      emoji:"📄", rarity:"common",    effect:"cia_classified_memo",        targetType:"none",   flavor:"eyes only. yours specifically.",                                         class:"USA!" },
  { id:"uav_recon",                name:"UAV Recon",                  cost:2,              type:"spell",  desc:"Discover 3 cards from enemy hand. Copy 1 to your hand.",                       emoji:"🛰️", rarity:"rare",      effect:"cia_uav_recon",              targetType:"none",   flavor:"satellite said 'no thoughts head empty just vibes from 30k feet' bestie.", class:"USA!" },
  { id:"mk_ultra_test",            name:"MK-Ultra Test",              cost:2,              type:"spell",  desc:"Take control of an enemy minion with 3 or less Attack until end of turn.",     emoji:"🧪", rarity:"rare",      effect:"mk_ultra_test",              targetType:"minion", flavor:"sip the kool-aid bestie. it's giving compliance fr.",                    class:"USA!", token:true },
  { id:"skibidi_bomb",             name:"Skibidi Bomb",               cost:4,              type:"spell",  desc:"Deal 3 damage to all enemy minions.",                                          emoji:"💣", rarity:"rare",      effect:"skibidi_bomb",               targetType:"none",   flavor:"delete this from existence no cap. ohio rizz energy.",                   class:"USA!" },
  ...
  { id:"romanian_compound",  name:"Romanian Compound",         cost:5,              type:"spell",  desc:"Gain 5 Armor. Summon a 2/8 Gate with Taunt. Draw a card.",                           emoji:"🏰", rarity:"legendary", effect:"romanian_compound_rework", targetType:"none",   flavor:"garage full. guest list shorter than the cigars.",       class:"Viral" },
...
export const EXPANSION_CARDS = [
  ...
  { id: "mk_ultra_intern", name: "MK-Ultra Intern", cost: 2, type: "minion", attack: 3, health: 2, emoji: "🥽", flavor: "they said 'free pizza friday' but i can hear colors now bestie 🍕", desc: "Battlecry: Add an MK-Ultra Test spell to your hand.", effect: "Battlecry: Add an MK-Ultra Test spell to your hand.", rarity: "common", class: "usa", keywords: ["battlecry"], effectConfig: { battlecry: { type: "add_card_to_hand", cardId: "mk_ultra_test" } } },
  ...
  { id: "area_51_whistleblower", name: "Area 51 Whistleblower", cost: 3, type: "minion", attack: 3, health: 3, emoji: "📢", flavor: "spilled the tea on national tv. now greg from accounting can fly fr 🛸", desc: "Battlecry: Summon a 4/4 UAP for your opponent.", effect: "Battlecry: Summon a 4/4 UAP for your opponent.", rarity: "rare", class: "usa", keywords: ["battlecry"], effectConfig: { battlecry: { type: "summon_token", target: "enemy", count: 1, token: { id: "uap_token", name: "UAP", atk: 4, hp: 4, type: "minion", rarity: "rare", class: "USA!", emoji: "🛸", desc: "Deathrattle: Summon two 4/4 Black Agents for your opponent.", keywords: ["deathrattle"], token: true, effectConfig: { on_death: { type: "summon_token", target: "enemy", count: 2, token: { id: "black_agent_token", name: "Black Agent", atk: 4, hp: 4, type: "minion", rarity: "rare", class: "USA!", emoji: "🕴️", desc: "Non-human biologics. Allegedly.", keywords: [], token: true } } } } } } },
  { id: "seal_team_six", name: "SEAL Team Six", cost: 6, type: "minion", attack: 6, health: 6, emoji: "🪖", flavor: "can't tell you what we did but the receipts say 'classified' 💀", desc: "Charge. Battlecry: Destroy a random enemy minion.", effect: "Charge. Battlecry: Destroy a random enemy minion.", rarity: "epic", class: "usa", keywords: ["charge", "battlecry"], effectConfig: { battlecry: { type: "destroy_random_enemy_minion" } } },
